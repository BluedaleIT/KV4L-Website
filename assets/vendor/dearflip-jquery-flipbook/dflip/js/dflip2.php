...
(function e(t, i) {
    ...
    var n = (t.defaults = {
        ...
        allControls: "altPrev,pageNumber,altNext,play,outline,thumbnail,zoomIn,zoomOut,fullScreen,share,download,search,more,pageMode,startPage,endPage",
        moreControls: "download,pageMode,startPage,endPage",
        hideControls: "",
        controlsPosition: t.CONTROLSPOSITION.TOP,
        paddingTop: 30,
        paddingLeft: 20,
        paddingRight: 20,
        paddingBottom: 30,
        ...
        pdfjsSrc: "assets/vendor/dearflip-jquery-flipbook/dflip/js/libs/pdf.min.js",
        pdfjsCompatibilitySrc: "assets/vendor/dearflip-jquery-flipbook/dflip/js/libs/compatibility.js",
        pdfjsWorkerSrc: "assets/vendor/dearflip-jquery-flipbook/dflip/js/libs/pdf.worker.min.js",
        threejsSrc: "assets/vendor/dearflip-jquery-flipbook/dflip/js/libs/three.min.js",
        mockupjsSrc: "assets/vendor/dearflip-jquery-flipbook/dflip/js/libs/mockup.min.js",
        soundFile: "assets/vendor/dearflip-jquery-flipbook/dflip/sound/turn2.mp3",
        imagesLocation: "assets/vendor/dearflip-jquery-flipbook/dflip/images",
        imageResourcesPath: "assets/vendor/dearflip-jquery-flipbook/dflip/images/pdfjs/",
        cMapUrl: "assets/vendor/dearflip-jquery-flipbook/dflip/cmaps/",
        ...
        var a = (function (e) {
            ...
            i.prototype.moveBy = function (e) {
                ...
                if (this.firstFlipped != true) {
                    this.previewObject.analytics({ eventAction: "ebook_first_page_fllp", options: this.previewObject.options });
...
DFLIP.Share = (function e(t) {
    function i(e, i) {
        ...
        n.whatsapp = t(a, { class: o + " df-share-whatsapp " + i.icons["whatsapp"] }).on("click", function (e) {
            window.open("https://api.whatsapp.com/send/?text=" + encodeURIComponent(n.shareUrl), "Sharer", r);
        });
        ...
        n.box.append(n.urlInput).append(n.whatsapp).append(n.facebook).append(n.twitter).append(n.mail);
