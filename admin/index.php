...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold "><?php echo $totalpageviews; ?></div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">Latest Date : <?php echo date("j/n/Y") ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Blog Views</div>
                                            <div class="h5 mb-0 font-weight-bold"><?php echo $totalblogviews; ?></div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">Latest Date : <?php echo date("j/n/Y") ?></div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total E-book Views</div>
                                            <div class="h5 mb-0 font-weight-bold "><?php echo $totalebookviews; ?></div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">Latest Date : <?php echo date("j/n/Y") ?></div>
    ...
    <script>document.getElementById("indexnav").classList.add('active');</script>
